...
Locust has no support for gRPC out of the box, but its docs provide a [clear example](https://docs.locust.io/en/stable/testing-other-systems.html#grpc) of how to use grpc with the tool.
